...
- **Effect:** The message disappears from _your_ screen, but everyone else can still see it.
- **How it works:**
...
- **Rules:** You can only do this for messages _you_ sent.
- **How it works:**
...
- **How it works:**
  ...
  - It bulk-adds a record into the `message_hides` table for _every_ message, tied to your `user_id`.
